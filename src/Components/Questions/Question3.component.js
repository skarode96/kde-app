...
function Question3() {
    ...
    let query = "PREFIX pp: <http://www.semanticweb.org/public-place#>\n" +
        ...
        "WHERE {\n" +
        "  ?subject  pp:hasMeetingRooms ?Is_Present.\n" +
        "  ?center pp:hasFacilities ?subject.\n" +
    ...
    return(
        <Container>
            ...
            <Row>
                <Col>
                    Which Sports and Recreation Clubs & Multi-Use Community Centres have meeting rooms to use?
                </Col>
                <Col>
